      ...
      //  console.log($('.message-error div').text());
        ...
        $(document).ready(function(){
	      $(".support-heading").click(function(){
		    $(this).next('.support-list').slideToggle();
		  });
	    });

		/*  $('body').on('click', '.support-heading', function(){
          console.log('footer-clicked');
          jQuery(this).next('.support-list').slideToggle();
        }); */
        // login modal design class
        $('.loginformtext').closest('.modal-popup').addClass('loginreg');  
