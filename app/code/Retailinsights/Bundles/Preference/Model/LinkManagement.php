...
namespace Retailinsights\Bundles\Preference\Model;
  ...
  /**
    ...
    private function processLinkedProduct(
	    ...
	    if ($product->getIsDuplicate()) {
            $selectionModel->setSelectionId(null);
        }
    ...
    private function mapProductLinkToBundleSelectionModel(
		...
		//echo $productLink->getUpdatedAt(); die;
		...
		if ($productLink->getUpdatedAt() !== null) {
            $selectionModel->setUpdatedAt($productLink->getUpdatedAt());
        }
