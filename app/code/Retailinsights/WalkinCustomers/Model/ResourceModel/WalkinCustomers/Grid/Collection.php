<?php
namespace Retailinsights\WalkinCustomers\Model\ResourceModel\WalkinCustomers\Grid;


use Magento\Framework\View\Element\UiComponent\DataProvider\Document as BlogModel;
use Retailinsights\WalkinCustomers\Model\ResourceModel\WalkinCustomers\Collection as OrderCollection;
    ...
    protected function _initSelect()
{
    ...
    ->joinLeft(
        ...
        ['main_table.id','main_table.order_id','main_table.tracking_title','main_table.tracking_number','so.increment_id','so.status','so.customer_email','so.base_grand_total','so.payment_method','so.billing_name','so.shipping_address','so.created_at']
        )
        ->joinLeft(
    ...
    public function __construct(
        ...
        $mainTable = 'walkin_other_couriers',
        // $eventPrefix,
        // $eventObject,
        $resourceModel = 'Retailinsights\WalkinCustomers\Model\ResourceModel\WalkinCustomers',
