<?php
namespace Retailinsights\ProcessCBOOrders\Model\ResourceModel\DeliveredCBOOrders\Grid;


use Magento\Framework\View\Element\UiComponent\DataProvider\Document as BlogModel;
use Retailinsights\ProcessCBOOrders\Model\ResourceModel\DeliveredCBOOrders\Collection as OrderCollection;
    ...
    protected function _initSelect()
{
    ...
    ->joinLeft(
        ...
        ['sop.shipping_address_id','sop.student_name','sop.roll_no' ,'sop.school_name' ,'sop.school_code']
        )
        ->joinLeft(
    ...
    {
        //$this->addFieldToFilter('status', array('in' => array('order_delivered','dispatched_to_courier')));
