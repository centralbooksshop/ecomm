   ...
   protected $resultRedirectFactory;
    ...
    public function execute()
    {
      try{
        ...
        $url1 = $result[0]['value'];
        $return_url = $url1.'cbsadmin/processcboorders/processcboshippingorders';
              ...
              if(!$orderId){
                ...
                if(($status == 'complete') || ($status == 'pending') || ($status == 'processing')){
                   ...
                   $shipment = $order->getShipmentsCollection();
                    ...
                    } elseif($isEcomLabel == 'yes') {
                      $collection[]= '<span>'.$order_id.' : Courier tracking info not exists</span><br/>';
					} elseif($isDelhiveryLabel == 'yes') {
                       $collection[]= '<span>'.$order_id.' : Courier tracking info not exists</span><br/>';
        ...
        $persistor->set('coloroption', $collection);
