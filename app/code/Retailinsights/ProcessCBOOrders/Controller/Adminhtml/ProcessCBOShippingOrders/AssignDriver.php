...
class AssignDriver extends \Magento\Backend\App\Action
{
    ...
    public function saveOrderDriver($incrementId, $driverId)
    {
        ...
        if($order->getId()){
            ...
            $model->addData([
                ...
                "tracking_title" =>'',
		"tracking_number" =>'',
		"delivered_order_id" => $incrementId
                ]);
    ...
    public function SendMessageAssignDriver($order){
       ...
       $msg = "Dear ".$custmerName.", Your order ".$incrementId." was picked up by ".$driver." ".$driverMobile.". You will receive the order in 5 working days. Reach us at ".$helpdesklink." for any assistance.
