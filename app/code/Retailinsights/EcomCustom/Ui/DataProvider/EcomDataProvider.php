<?php
namespace Retailinsights\EcomCustom\Ui\DataProvider;

use Retailinsights\ProcessCBOOrders\Model\ResourceModel\ProcessCBOOrders\Grid\CollectionFactory;



class EcomDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
   /**
     * @var array
     */
    ...
    public function __construct(
       ...
       // ->addFieldToFilter('tracking_title', array('in' => array('ecomexpress')));
