<?php
namespace Retailinsights\EcomCustom\Model\ResourceModel\ProcessEcomOrders\Grid;


use Magento\Framework\View\Element\UiComponent\DataProvider\Document as BlogModel;
use Retailinsights\EcomCustom\Model\ResourceModel\ProcessEcomOrders\Collection as OrderCollection;
...
class Collection extends OrderCollection implements \Magento\Framework\Api\Search\SearchResultInterface
{
    ...
    public function _renderFiltersBefore()
    {
        ...
        $this->addFieldToFilter('tracking_title', array('in' => array('ecomexpress')));
