<?php
namespace Retailinsights\DeliveryCustom\Ui\DataProvider;

use Retailinsights\ProcessCBOOrders\Model\ResourceModel\ProcessCBOOrders\Grid\CollectionFactory;



class DelhiveryDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
     * @var array
     */
    ...
    public function __construct(
        ...
        ->addFieldToFilter('tracking_title', array('in' => array('delhivery')));
