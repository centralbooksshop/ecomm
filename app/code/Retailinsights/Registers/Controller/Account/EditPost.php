...
namespace Retailinsights\Registers\Controller\Account;
...
class EditPost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
			...
			//echo '<pre>'; print_r($customerCandidate);die;
    ...
    private function populateNewCustomerDataObject(
        ...
        $custom_attributes = $currentCustomerData->getCustomAttributes();
		$custom_attributes_mobile = $custom_attributes['mobile_number'];
		$mobile_number = $custom_attributes_mobile->getValue();
		...
		//echo '<pre>'; print_r($customerDto);die;
		...
		if (!empty($mobile_number)) {
			  $customerDto->setCustomAttribute('mobile_number', $mobile_number);
        }
    ...
    {
        echo '<pre>';print_r($currentCustomerDataObject);die;
