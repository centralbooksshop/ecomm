<?php
namespace Retailinsights\FedExCustom\Model\ResourceModel\ProcessFedexOrders\Grid;


use Magento\Framework\View\Element\UiComponent\DataProvider\Document as BlogModel;
use Retailinsights\FedExCustom\Model\ResourceModel\ProcessFedexOrders\Collection as OrderCollection;
    ...
    protected function _initSelect()
{
    ...
    ->joinLeft(
        ...
        ['sop.shipping_address_id','sop.student_name','sop.roll_no','sop.created_at','sop.shipment_type']
        )
        ->joinLeft(
