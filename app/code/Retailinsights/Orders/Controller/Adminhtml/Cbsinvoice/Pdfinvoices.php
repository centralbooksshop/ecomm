<?php
	namespace Retailinsights\Orders\Controller\Adminhtml\Cbsinvoice;
	...
	use Retailinsights\CentralbooksShipping\Model\Order\Pdf\Invoice;
		 ...
		 protected function massAction(AbstractCollection $collection)
    {
		...
		//echo 'ravi';echo'<pre>';print_r($pdf);die;
