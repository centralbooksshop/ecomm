...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                foreach ($itemIds as $itemId) {
                    $post = $this->_objectManager->get('Retailinsights\Cancellayer\Model\Similarproductsattributes')->load($itemId);
                    $post->delete();
                }
        ...
        return $this->resultRedirectFactory->create()->setPath('cancellayer/*/index');
    }
}