...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Retailinsights\Reasonlayer\Model\Similarproductsattributes')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('reasonlayer/*/index');
    }
