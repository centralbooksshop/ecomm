...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Retailinsights_Reasonlayer::Similarproductsattributes')
            ->addBreadcrumb(__('Retailinsights Reasonlayer'), __('Retailinsights Reasonlayer'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Retailinsights\Reasonlayer\Model\Similarproductsattributes');
