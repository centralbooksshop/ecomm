<?php
namespace Retailinsights\DelhiveryCustom\Model\ResourceModel\ProcessDelhiveryOrders\Grid;


use Magento\Framework\View\Element\UiComponent\DataProvider\Document as BlogModel;
use Retailinsights\DelhiveryCustom\Model\ResourceModel\ProcessDelhiveryOrders\Collection as OrderCollection;
...
class Collection extends OrderCollection implements \Magento\Framework\Api\Search\SearchResultInterface
{
    ...
    public function _renderFiltersBefore()
    {
        ...
        $this->addFieldToFilter('tracking_title', array('in' => array('delhivery')));
