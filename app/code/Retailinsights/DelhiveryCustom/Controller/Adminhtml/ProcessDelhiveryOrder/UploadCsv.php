<?php
namespace Retailinsights\DelhiveryCustom\Controller\Adminhtml\ProcessDelhiveryOrder;
   ...
   protected $resultRedirectFactory;
    ...
    public function execute()
    {
      try{
        ...
        $url1 = $result[0]['value'];
        $return_url = $url1.'cbsadmin/delhiverycustom/ProcessDelhiveryOrder';
                ...
                if(($status == 'complete') || ($status == 'pending') || ($status == 'processing')){
                   ...
                   $shipment = $order->getShipmentsCollection();
                    $flag = $this->checkPayslipGenerated($orderInfo);
                     $isLabel = $this->checkDelhiveryLabel($orderInfo);
        ...
        $persistor->set('coloroptionDelhivery', $collection);
