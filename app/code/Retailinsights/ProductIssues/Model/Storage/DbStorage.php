...
namespace Retailinsights\ProductIssues\Model\Storage;
...
class DbStorage extends \Magento\UrlRewrite\Model\Storage\DbStorage
{
    ...
    protected function doReplace(array $urls): array
    {
        ...
        try {
			...
			$sql = "delete from catalog_product_entity_varchar where attribute_id = '122' and entity_id = '$entity_id'";
			 //$exists = $this->connection($sql);
