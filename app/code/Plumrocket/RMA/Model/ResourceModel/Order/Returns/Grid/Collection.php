...
class Collection extends SearchResult
{
    ...
    protected function _initSelect()
    {
		...
		$variable = $objectManager->get('Magento\Variable\Model\Variable');
		$rmastartDatevalue = $variable->loadByCode('rma-request-startdate', 'admin');
		$startDate = $rmastartDatevalue->getPlainValue();
		$rmaendDatevalue = $variable->loadByCode('rma-request-enddate', 'admin');
