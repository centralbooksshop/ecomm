<?php
namespace Centralbooks\ClickpostExtension\Model\ResourceModel;
...
class Awb extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('clickpost_waybill', 'awb_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Shipsy\EcommerceExtension\Model\Awb $object
     * @return $this
     */
