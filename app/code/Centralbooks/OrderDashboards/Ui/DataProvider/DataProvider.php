...
namespace Centralbooks\OrderDashboards\Ui\DataProvider;
...
class DataProvider extends \Magento\Framework\View\Element\UiComponent\DataProvider\DataProvider
{
    ...
    protected function prepareUpdateUrl()
    {
		...
		//echo '<pre>';print_r($this->data['config']['filter_url_params']);die;
        foreach ($this->data['config']['filter_url_params'] as $paramName => $paramValue) {
            ...
            if ($paramValue) {
                ...
                if($paramName == 'created_at') {
				    //echo $paramName;die;
					$this->addFilter(
						$this->filterBuilder->setField($paramName)->setValue($paramValue)->setConditionType('gteq')->create()
					);
				} else {
                    $this->addFilter(
    ...
    protected function searchResultToOutput(SearchResultInterface $searchResult)
    {
        ...
        foreach ($searchResult->getItems() as $item) {
			...
			if (!empty($customAttributes) && (is_array($customAttributes) || $customAttributes instanceof \Traversable)) {
