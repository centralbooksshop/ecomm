...
class Edit extends \Centralbooks\Zones\Controller\Adminhtml\Addzone
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('zones_addzone', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Zone'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Zone %1', $model->getId()) : __('New Zone'));
        return $resultPage;
    }
