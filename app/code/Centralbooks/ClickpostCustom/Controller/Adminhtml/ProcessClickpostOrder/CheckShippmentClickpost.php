...
namespace Centralbooks\ClickpostCustom\Controller\Adminhtml\ProcessClickpostOrder;
...
class CheckShippmentClickpost extends \Magento\Backend\App\Action
{
    protected $_resultPageFactory;
    protected $orderRepository;
    private $searchCriteriaBuilder;
    private $invoiceCountCollection;
    private $delhiveryLabels;
    ...
    public function getOrderStatus($orderIncrementId)
    {
        ...
        if($status == "dispatched_to_courier"){
            ...
            $isClickpostLabel = $this->checkClickpostLabel($orderInfo);
            if($isClickpostLabel == 'no'){
                return 'no_tracking_info';
            }
	...
	public function checkClickpostLabel($order)
    {
        $orderId = $order->getId();
