 ...
 */
namespace Webkul\DeliveryBoy\Model\ResourceModel\Comment;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\DeliveryBoy\Model\Comment::class,
            \Webkul\DeliveryBoy\Model\ResourceModel\Comment::class
        );
     ...
     */
    public function setCommentData($condition, $attributeData)
    {
        return $this->getConnection()->update(
            $this->getTable("deliveryboy_comments"),
            $attributeData,
            $where = $condition
        );
    }
