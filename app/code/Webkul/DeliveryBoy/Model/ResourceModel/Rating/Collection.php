 ...
 */
namespace Webkul\DeliveryBoy\Model\ResourceModel\Rating;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\DeliveryBoy\Model\Rating::class,
    ...
    /**
     * Set Rating attributes data.
     *
     * @param mixed $condition UPDATE WHERE clause(s).
     * @param array $attributeData Column-value pairs.
     * @return int The number of affected rows.
     */
    public function setRatingData($condition, $attributeData)
    {
        return $this->getConnection()->update(
            $this->getTable("deliveryboy_rating"),
            $attributeData,
            $where = $condition
        );
    }
