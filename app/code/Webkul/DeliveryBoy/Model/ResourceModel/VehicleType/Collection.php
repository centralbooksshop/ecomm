 ...
 */
namespace Webkul\DeliveryBoy\Model\ResourceModel\VehicleType;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\DeliveryBoy\Model\VehicleType::class,
            \Webkul\DeliveryBoy\Model\ResourceModel\VehicleType::class
        );
     ...
     */
    public function setVehicleTypeData($condition, $attributeData)
    {
        return $this->getConnection()->update(
            $this->getTable("deliveryboy_vehicle_type"),
            $attributeData,
            $where = $condition
        );
    }
