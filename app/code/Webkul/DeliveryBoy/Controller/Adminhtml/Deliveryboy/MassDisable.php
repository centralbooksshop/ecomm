...
class MassDisable extends \Webkul\DeliveryBoy\Controller\Adminhtml\Deliveryboy
{
    /**
     * Mass disable deliveryboys.
     *
    ...
    public function execute()
    {
        ...
        $collection->setDeliveryboyData($coditionData, ["status"=>0]);
        if ($deliveryboysUpdated) {
            $this->messageManager->addSuccess(__("A total of %1 record(s) were disabled.", $deliveryboysUpdated));
        }
