...
class GetDeliveryboyReviewList extends AbstractRating
{
    ...
    public function execute()
    {
        try {
            ...
            $deliveryboyCollection->getSelect()->reset(\Magento\Framework\DB\Select::COLUMNS);
            ...
            foreach ($deliveryboyCollection as $deliveryboy) {
                $deliveryboyReviewList[] = $this->buildReviewDataForAppFromReviewModel($this->mFactor, $deliveryboy);
            }
    ...
    /**
     * Add Pagination to Delvieryboy Collection.
     *
     * @param \Webkul\DeliveryBoy\Model\ResourceModel\Deliveryboy\Collection $collection
     * @return int
     */
