...
class OrderDetails extends AbstractDeliveryboy
{
    ...
    protected function verifyUsernData(): void
    {
        ...
        if ($this->order->getId()) {
            ...
            if ($deliveryBoyOrder['package_items']) {            
                $this->returnArray["no_of_covers"] = intval(explode(',', $deliveryBoyOrder['package_items'])[0]);
                $this->returnArray["no_of_boxes"] = intval(explode(',', $deliveryBoyOrder['package_items'])[1]);
            }
            $this->returnArray["delivery_amount"] = $deliveryBoyOrder['delivery_amount'];
            $this->returnArray["otp"] = $deliveryBoyOrder['otp'];
            $orderStatus = [];
            $statusLabel = [];
    ...
    /**
     * Get Deliveryboy Rating.
     *
     * @return void
     */
    protected function getDeliveryboyRating(): void
    {
     ...
     * @return void
     */
    public function getOrderItems($order): void
    {
		...
		if ($this->isDeliveryboy && in_array($item->getProductType(), ['virtual','downloadable'])) {
...
/*            $eachItem["thumbNail"] = $this->helperCatalog->getImageUrl(
    ...
    /**
     * GEt Deliveryboy order resource collection.
     *
    ...
    /**
     * Reset Deliveryboy Order Resource Collection.
     *
     ...
     * @return void
     */
    public function appendTotalAmount()
    {
        $this->returnArray['totalAmount'] = $this->order->getGrandTotal();
    }
     ...
     * @return void
     */
    public function appendOrderTotal()
    {
     ...
     * @return void
     */
    public function attachPickupAddress()
    {
