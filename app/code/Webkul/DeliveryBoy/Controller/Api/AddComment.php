...
{
    public const COMMENTOR_ADMIN = "Admin";
    ...
    public function execute()
    {
        try {
            ...
            $this->returnArray["message"] = (string)__("Reason added successfully.");
    ...
    public function verifyRequest(): void
    {
        ...
        if (str_word_count($this->comment < 5)) {
            throw new LocalizedException(__("Reason should be at least 5 words."));
        }
    }
