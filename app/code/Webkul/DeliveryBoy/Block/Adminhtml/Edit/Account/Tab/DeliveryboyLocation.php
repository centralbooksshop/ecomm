...
class DeliveryboyLocation extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     */
    public const CONFIGURATION_PATH_GOOGLE_MAP_KEY = 'deliveryboy/configuration/map_key';
     ...
     * @param DeliveryBoy\CollectionFactory $deliveryboyResourceCollectionFactory
    ...
    {
        $key = $this->deliveryboyHelper->getGoogleMapKey();
        return $key;
    }
