...
class ReasonGrid extends \Magento\Backend\Block\Widget\Grid\Extended implements
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Webkul\DeliveryBoy\Model\ResourceModel\Reason\CollectionFactory
     */
     ...
     * @param \Webkul\DeliveryBoy\Model\ResourceModel\Reason\CollectionFactory $reasonCollectionFactory
     * @param \Magento\Framework\Registry $coreRegistry
     * @param \Magento\Framework\Stdlib\DateTime\DateTime $dateTime
     * @param \Webkul\DeliveryBoy\Model\ResourceModel\Order\CollectionFactory $deliveryboyOrderResColF
     * @param array $data
     */
    ...
    /**
     * Prepare Collection for rendering grid.
     *
     * @return \Magento\Backend\Block\Widget\Grid\Extended
     */
    protected function _prepareCollection()
    {
        $commentCollection = $this->reasonCollectionFactory->create();
    ...
    {
        return __('Deliveryboy Not Delivered Order Reason List');
    }
    ...
    /**
     * Return boolean flag for toggling Tab.
     *
     * @return bool
     */
    ...
    /**
     * Check Wheter the tab is hidden or not.
     *
     * @return bool
     */
