...
class NotDelivered extends \Magento\Backend\Block\Template implements
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    /**
     * @var string
     */
    protected $_template = 'order/not_delivered.phtml';
    ...
    */
    ...
    {
        return __('Add Reason for Deliveryboy Not Delivered Order');
    }
