...
class TrackButton extends \Magento\Framework\View\Element\Template
{
    ...
    public function getDeliveryBoyOrder()
    {
        ...
        $deliveryboyOrderCollection = $this->deliveryBoyOrderCollectionF->create()
			...
			->addFieldToFilter(OrderInterface::ORDER_STATUS, 'dispatched_to_courier')
    ...
    /**
     * Check whether delvieryboy has picked up the order or not.
     *
     * @return bool
     */
    public function canTrackOrder()
    {
        return !empty($this->getDeliveryBoy()->getId());
    }

    /**
     * GEt Order Location Url.
     *
     * @return string
     */
