...
class DeliveryboyReviewEvaluationObserver implements \Magento\Framework\Event\ObserverInterface
{
    /**
     * @var Data
     */
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        try {
            ...
            $templateId = ModuleGlobalConstants::DELIVEYBOY_REVIEW_EVALUATION_EMAIL_TEMPLATE_ID;
