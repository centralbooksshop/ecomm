...
class SalesOrderPlaceAfterObserver implements \Magento\Framework\Event\ObserverInterface
{
     ...
     * @param \Webkul\DeliveryBoy\Helper\Authentication $authenticationHelper
    ...
    public function __construct(
        ...
        \Webkul\DeliveryBoy\Helper\Authentication $authenticationHelper,
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        try {
            ...
            foreach ($orders as $order) {
                ...
                $this->autoAssignDeliveryBoys($order);
            }
        } catch (\Throwable $e) {
    ...
    /**
     * Auto assign delvieryboy on order place.
     *
     * @param Order $order
     * @return void
     */
    public function autoAssignDeliveryBoys($order)
    {
        $environment = $this->emulate->startEnvironmentEmulation(
            $order->getStoreId(),
        ...
        $this->deliveryAutomationHelper->autoAssignDeliveryboyOnOrderPlace($order, $this->authenticationHelper);
        $this->emulate->stopEnvironmentEmulation($environment);
    }
}
