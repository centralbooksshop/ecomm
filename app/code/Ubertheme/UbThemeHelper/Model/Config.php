 ...
 */
namespace Ubertheme\UbThemeHelper\Model;
...
class Config extends \Magento\Framework\DataObject
{
     ...
     * Config data loader
     *
     * @var \Ubertheme\UbThemeHelper\Model\Config\Loader
     */
     ...
     * Config data factory
     *
     * @var \Ubertheme\UbThemeHelper\App\Config\ValueFactory
     */
     ...
     * @param Config\Loader $configLoader
     * @param \Ubertheme\UbThemeHelper\App\Config\ValueFactory $configValueFactory
    ...
    public function __construct(
        ...
        \Ubertheme\UbThemeHelper\Model\Config\Loader $configLoader,
        \Ubertheme\UbThemeHelper\App\Config\ValueFactory $configValueFactory,
    ...
    )
    {
         ...
         */
        /** @var $group \Ubertheme\UbThemeHelper\Model\Config\Structure\Element\Group */
        ...
        if (isset($groupData['fields'])) {
            ...
            foreach ($groupData['fields'] as $fieldId => $fieldData) {
                ...
                $initialValue = $this->getInitialConfigValue($path);
                if ($fieldData['value'] == $initialValue) {
                    $inherit = true;
                }
    ...
    protected function getInitialConfigValue($path)
    {
        ...
        $path = explode("/", $path);
        if (isset($config[$path[0]][$path[1]][$path[2]])) {
            $value = $config[$path[0]][$path[1]][$path[2]];
        }
