...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
     ...
     *
     * @var \Ubertheme\UbThemeHelper\Block\Adminhtml\Config\Form\Field
     */
     ...
     * Form field factory
     *
     * @var \Ubertheme\UbThemeHelper\Block\Adminhtml\Config\Form\FieldFactory
     */
    protected $_fieldFactory;

    /** @var \Ubertheme\UbThemeHelper\Helper\Data $_settingHelper */
     ...
     * @param Form\FieldFactory $fieldFactory
     * @param \Magento\Framework\ObjectManagerInterface $objectManager
     * @param \Ubertheme\UbThemeHelper\Helper\Data $settingHelper
    ...
    public function __construct(
        ...
        \Ubertheme\UbThemeHelper\Block\Adminhtml\Config\Form\FieldFactory $fieldFactory,
        \Magento\Framework\ObjectManagerInterface $objectManager,
        \Ubertheme\UbThemeHelper\Helper\Data $settingHelper,
     ...
     *
     * @return \Ubertheme\UbThemeHelper\Block\Adminhtml\Dependence
     */
    protected function _getDependence()
    {
        if (!$this->getChildBlock('element_dependence')) {
            $this->addChild('element_dependence', 'Ubertheme\UbThemeHelper\Block\Adminhtml\Dependence');
        }
    ...
    protected function _initElement(
        ...
        if (array_key_exists($path, $this->_configData)) {
            ...
            $initialData = $this->getInitialConfigValue($path);
            $inherit = ($data != $initialData) ? false  : true;
        ...
        $fieldConfigData = $field->getData();
        //add more default data value
        $fieldConfigData['default_value'] = $this->getInitialConfigValue($path);
    ...
    {
    	return $this->getRequest()->getParam('themeId', '');
    }
    ...
    protected function getInitialConfigValue($path)
    {
        $value = null;
        //get initial config values (values from config.xml)
        $scope = \Magento\Framework\App\Config\ScopeConfigInterface::SCOPE_TYPE_DEFAULT;
        $config = $this->_initialConfig->getData($scope);
        //section_name/group_name/field_name => coming soon
        $path = explode("/", $path);
        if (count($path)) {
            $param = '[';
            ...
            $var = 'config'.$param;
            echo eval ('if(isset($'.$var.')) $value = $'.$var .';');
        }
