...
class GoogleFonts2 extends \Magento\Config\Block\System\Config\Form\Field
{
    /**
                 ...
                 "webfont",
                    ...
                    $(document).ready(function () {
                        ...
                        $.fn.higooglefonts = function(options) {
                            ...
                            var fontMap   =   fontMap || [];
                            fonts2.forEach(function(font,index) {
                                fontMap.push({
                                    id     :   font,
                                    text   :   font,
                                    itemId :   index
                        ...
                        $( "#' . $element->getHtmlId() . '" ).higooglefonts({
    ...
    {
        $url = 'https://raw.githubusercontent.com/google/fonts/master/tools/font-metadata.csv';
