...
class AjaxImportCategories extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $categoriesTree = $this->buildCategoriesTree($importType, $storeId, $categoryIds);
     ...
     * @return array
     */
    public function buildCategoriesTree($importType, $storeId = 0, $selectedCategoryIds = [])
    {
     ...
     * @return bool
     */
    public function addMenuItems(&$mapping, $items = [], $defaultData = [], $categoryIds = [], $parentMenuItemId = null) {
        $itemIds = [];
        foreach ($items as $key => $item) {
            ...
            if(array_key_exists('child', $item)) {
                $this->addMenuItems($mapping, $item['child'], $defaultData, $categoryIds, $parentMenuItemId);
            }
        }
