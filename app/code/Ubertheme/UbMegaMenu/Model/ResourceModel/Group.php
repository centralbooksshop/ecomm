...
class Group extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    protected function _beforeSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        if ($this->isExistsIdentifier($object)) {
            $msg = "The Store Views and Customer Groups you selected have already been assigned to another menu group with the same \"%1\" Menu Identifier.";
            throw new \Magento\Framework\Exception\LocalizedException(
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $table = $this->getTable('ubmegamenu_group_customer_group');
     ...
     * @param string $field
     * @param mixed $value
     * @param \Ubertheme\UbMegaMenu\Model\Group $object
    ...
    public function isExistsIdentifier(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $select = $this->getConnection()->select()->from(
            ...
            ['gcg' => $this->getTable('ubmegamenu_group_customer_group')],
    ...
    public function lookupCustomerGroupIds($groupId)
    {
        ...
        $select = $connection->select()->from(
            $this->getTable('ubmegamenu_group_customer_group'),
            'customer_group_id'
        )->where(
            'group_id = :group_id'
        );
