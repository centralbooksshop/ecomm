...
abstract class AbstractPdf extends \Magento\Framework\DataObject
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $package_collection = $objectManager->get('Magento\Catalog\Model\Product')->getCollection()->addAttributeToSelect('*')
             //->addAttributeToSelect('ecom_length')
    ...
    {
        $rendererData = array(
							    "bundle" => "Ecom\Ecomexpress\Model\Order\Pdf\Shipment",
							    "default" => "Ecom\Ecomexpress\Model\Order\Pdf\Shipment\DefaultShipment"		
        );
