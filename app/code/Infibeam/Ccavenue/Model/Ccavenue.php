    ...
    public function postProcessing(\Magento\Sales\Model\Order $order,
        ...
        if($response['order_status'] != 'Success'){
			...
			if (!$order->hasInvoices()) {
				$this->_logger->info('success call for Order #' . $order->getIncrementId());
				...
				// Optional: Log duplicate callback
                $this->_logger->info('Duplicate success callback ignored for Order #' . $order->getIncrementId());
